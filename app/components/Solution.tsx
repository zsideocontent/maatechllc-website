  ...
  return (
    <section className="py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="neo-raised rounded-[2rem] p-6 sm:p-10 max-w-4xl mx-auto">
          <div className="grid sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {flow.map((step, i) => (
              <div key={step} className="flex sm:flex-col items-center gap-4 sm:gap-3 sm:text-center">
                <div className="neo-pressed flex-shrink-0 w-12 h-12 rounded-2xl flex items-center justify-center font-extrabold text-[#6C3FF5]">
                  {i + 1}
                </div>
